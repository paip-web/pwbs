...
interface ModedTaskObject {
    ...
    os: PWBSPlatform, // Task Platform
    deprecated: boolean, // Error if PWBS want to start this task
    comment: string, // Comment of this task
}
/// Task Type
...
type PWBSPluginListArray = string[];
// Config Interface
...
interface PWBSLocalConfigurationFile {
    ...
    plugins: PWBSPluginList | PWBSPluginListArray, /// Plugins to use when executing this config
}
